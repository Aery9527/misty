...
public interface SmoothDomainLifecycleFactory {
    ...
    SmoothManagerLifecycle findManagerLifecycle(SmoothLoaderArgument loaderArgument, SmoothDomainClassLoader cl);

    SmoothModuleLifecycle findModuleLifecycle(SmoothLoaderArgument loaderArgument, SmoothDomainClassLoader cl);
