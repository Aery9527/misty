...
public class SmoothDomainLoaderFactoryPreset implements SmoothDomainLoaderFactory {
    ...
    @Override
    public SmoothManagerDomainLoader buildManagerLoader(SmoothUnscalableMap loaderArgument, Collection<URL> sources)
    ...
    @SuppressWarnings("DuplicatedCode")
    @Override
    public SmoothModuleDomainLoader buildModuleLoader(SmoothUnscalableMap loaderArgument, Collection<URL> sources)
            throws SmoothLoadException {
