...
class FieldExtractorTest {
    ...
    public static class ErrorObjectTester {
        ...
        public ErrorObjectTester(FiBiFunction<String, Class<?>, FieldObjectAbstract> builder) {
    ...
    public static class ErrorPrimitiveTester {
        ...
        private final FiFunction<String, FieldObjectAbstract> builder;

        public ErrorPrimitiveTester(FiFunction<String, FieldObjectAbstract> builder) {
            this.builder = builder;
        }
