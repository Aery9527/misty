...
import org.misty.util.reflect.method.MethodArg0ReturnInvoker;
import org.misty.util.reflect.method.MethodExtractor;
import org.misty.util.reflect.vo.ObjectAnalyzeInfo;
import org.misty.util.reflect.vo.ObjectGenericClearly;
...
//        ObjectAncestorAnalyzeProcessor processor = processorMap.get(ownerClass);
        ...
        for (Analyzer analyzer : this.analyzers) {
            ...
            ClassRepository genericInfo = extractGenericInfo(genericDeclaration);
        ...
        ObjectAnalyzeInfo info = new ObjectAnalyzeInfo(this.ownerClass, genericDetails.toArray(new ObjectGenericDetail[genericDetails.size()]));
        return info;
    }
