...
public class ExaminerMessage {
    ...
    public static String requireInRange(String term, long arg, long floor, long ceiling, RangeIntervals intervals) {
        return String.format(REQUIRE_RANGE, term, arg, intervals.getFloorSymbol(), floor, ceiling, intervals.getCeilingSymbol());
    }

    public static String requireInRange(String term, float arg, float floor, float ceiling, RangeIntervals intervals) {
        return String.format(REQUIRE_RANGE, term, arg, intervals.getFloorSymbol(), floor, ceiling, intervals.getCeilingSymbol());
    }

    public static String requireInRange(String term, double arg, double floor, double ceiling, RangeIntervals intervals) {
        return String.format(REQUIRE_RANGE, term, arg, intervals.getFloorSymbol(), floor, ceiling, intervals.getCeilingSymbol());
    }

    public static String requireInRange(String term, char arg, char floor, char ceiling, RangeIntervals intervals) {
        return String.format(REQUIRE_RANGE, term, arg, intervals.getFloorSymbol(), floor, ceiling, intervals.getCeilingSymbol());
    }

    public static String requireInRange(String term, byte arg, byte floor, byte ceiling, RangeIntervals intervals) {
        return String.format(REQUIRE_RANGE, term, arg, intervals.getFloorSymbol(), floor, ceiling, intervals.getCeilingSymbol());
    }

    public static String requireInRange(String term, Character arg, Character floor, Character ceiling, RangeIntervals intervals) {
        return String.format(REQUIRE_RANGE, term, arg, intervals.getFloorSymbol(), floor, ceiling, intervals.getCeilingSymbol());
    }

    public static String requireInRange(String term, Number arg, Number floor, Number ceiling, RangeIntervals intervals) {
        return String.format(REQUIRE_RANGE, term, arg, intervals.getFloorSymbol(), floor, ceiling, intervals.getCeilingSymbol());
    }
